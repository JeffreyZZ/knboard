    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('column', adminsortable.fields.SortableForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='column', to='boards.column')),
        ...
        migrations.AddIndex(
            model_name='question',
            index=models.Index(fields=['user_id', 'create_time', 'update_time', 'vote_count'], name='boards_ques_user_id_7f4ead_idx'),
        ),
