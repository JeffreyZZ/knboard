...
class Task(SortableMixin, TimeStampedModel):
    ...
    user_id = models.PositiveIntegerField() #Comment="用户ID"
    ...
    vote_up_count = models.PositiveIntegerField(default=0) #Comment="赞成票总数"
    vote_down_count = models.PositiveIntegerField(default=0) #Comment="反对票总数"
