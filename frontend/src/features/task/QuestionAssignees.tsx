...
import { BoardMember, IQuestion } from "types";
import { PRIMARY } from "utils/colors";
import { patchQuestion } from "./ColumnItemSlice";
...
const QuestionAssignees = ({ question }: Props) => {
  ...
  const handleClose = () => {
    ...
    if (
      ...
      dispatch(
        patchQuestion({
          id: Number(question.id.substring(1)),
...
export default QuestionAssignees;
